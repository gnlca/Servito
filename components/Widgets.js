    ...
    return(
        <div className="Widgets">
            <div className="griglia">
                ...
                <div className="cpu  extendedFont" > freeRam<br/><span style={{fontSize:"x-large"}}>1338MB</span></div>
                <div className="cpu  extendedFont">hostname<br/><span style={{fontSize:"x-large"}}>agpi</span></div>
